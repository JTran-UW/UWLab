...
keys = ["Metrics/task_command/end_of_episode_success_rate", "Metrics/task_command/task_2_success_rate", "Metrics/task_command/task_3_success_rate",
        "Episode_Termination/abnormal_robot", "Loss/entropy", "Loss/learning_rate", "Loss/value_function", "Train/mean_reward", "Policy/mean_noise_std"]
data = {}
...
for s in [200, 250, 275, 300, 325, 350, 375, 400, 450]:
    print(f"--- it {s}")
