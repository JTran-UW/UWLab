...
# TODO: replace ACCOUNT default with your Hyak account (e.g. weirdlab, socialrl, etc.)
...
CONSTRAINT=${CONSTRAINT:-"h200|l40|l40s|a100"}
...
SLURM_LOG_DIR=${SLURM_LOG_DIR:-/mmfs1/gscratch/scrubbed/jtran/slurm_logs}
...
#SBATCH --output=/mmfs1/gscratch/scrubbed/jtran/slurm_logs/%x-%j.out
#SBATCH --error=/mmfs1/gscratch/scrubbed/jtran/slurm_logs/%x-%j.err
